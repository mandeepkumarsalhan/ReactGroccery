        ...
        <footer className="bg-zinc-100 py-20 ">
            <div className="flex flex-wrap gap-y-12 max-w-[1400px] mx-auto px-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-6 text-zinc-600">Questions or Feedbacks?<br /> We'd love to hear from you.</p>
                    <div className="flex bg-white p-1 rounded-lg mt-6">
                        ...
                        <button className="bg-gradient-to-b from-orange-400 to-orange-500 text-white p-2 rounded-lg text-2xl hover:to-orange-600 cursor-pointer"><IoIosArrowForward /></button>
                    </div>
                </div>
            </div>
        </footer>
